...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const prompt = `Du er dansk mediepædagogisk ekspert for skaermtjek.dk (forældreguide).

Vurder "${title}" (${platformLabel})${episode ? ' - afsnit: ' + episode : ''}${notes ? ' - kontekst: ' + notes : ''}.

Generer dansk JSON (1=lav bekymring, 10=høj):
...
"ai_analysis": "<3-4 sætninger: titel, vigtigste positive, vigtigste bekymring, alders-anbefaling>",
"ai_bullets": [
  {"icon":"<emoji>","highlight":"<1-3 ord>","text":"<max 60 tegn>"}
],
"ai_category_texts": {
  "violence":"<2 sætninger konkret hvorfor scoren>",
  "language":"<samme>","dopamine":"<samme>","retention":"<samme>","commercialism":"<samme>","values":"<samme>","sexual":"<samme>","fear":"<samme>","passive":"<samme>","socialpressure":"<samme>"
},
"ai_faq": [{"q":"<spørgsmål>","a":"<1-2 sætninger>"}]
}

Krav:
- Faktabaseret, kun sikker viden
- 4 bullets (mix positivt/bekymring), 3 FAQ
- Bullet-ikoner: ✨💡🎨🧠📚⚔️🗣️🎰🔔💰🔞😨👥
- values: 1=fremragende forbillede, 10=problematisk
- passive: 1=aktivt, 10=passivt
- Kort og konkret dansk
